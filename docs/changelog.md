...
- 貫入双晶の双晶軸が、生成元結晶と派生結晶の結晶軸中心を通るように修正しました。
- UIを調整しました。
...
- Fixed penetration twins so the twin axis passes through the crystal-axis centers of both the source and derived crystals.
- Adjusted the UI.
